...
class PopularModel {
  ...
  factory PopularModel.fromJSON(Map<String, dynamic> mapa){
    return PopularModel(
      ...
      id: mapa['id'],
      originalLanguage: mapa['originalLanguague'],
      originalTitle: mapa['original_title'],
      overview: mapa['overview'],
      popularity: mapa['popularity'],
      posterPath: mapa['posterPath'] ?? '',
      title: mapa['title'],
      voteAverage: mapa['vote_average'] is int ? (mapa['vote_average'] as int).toDouble() : mapa['vote_average'],
